...
%
%\input{\seWaPathSty/se-wa-input-styles-v095}
\input{se-wa-styles/se-wa-input-styles-v095}
...
thema=Fallstudie,
verfasser={Jörn Hübner, Patrick Knerr, Marco Riege, Matthias Liedtke, Oliver
Frendo},
...
\newpage
\chapter{Analyse}
\input{parts/spielideen}
\input{parts/usecase}
\input{parts/architektur}
\input{parts/joern} %OOA
\input{parts/optimierung}
\input{parts/vertraege}
...
\input{parts/design}
\input{parts/swing}
\input{parts/unittests}
\input{parts/balancing}

\newpage
\chapter{Fazit}\label{matthias:fazit}
\input{parts/betrachtung}
\input{parts/ausblick}

\newpage
\chapter{Aufgabenverteilung}
\input{parts/aufteilung}
...
\seEhrenwoertlicheErklaerung[Fallstudie]
