...
Ein wichtiger Teil des Spiels ist für den Benutzer das Abschließen von
...
Algorithmus wird jede Runde erneut durchgeführt, damit eine Preiskonkurrenz
...
(Bekanntheit und Beliebtheit sind hier Werte zwischen $0$ und $1$.
...
sich bei $S(x_d/y_0)$ befindet, wobei $x_d$ den Durchschnittspreis der Stadt
