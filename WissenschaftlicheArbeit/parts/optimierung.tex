...
Zunächst das Problem folgendermaßen dargestellt werden: \\
$k$ Kraftwerke mit einer Produktion von $k_i$ haben je $x$ Verbindungen zu $s$
Städten mit je $y$ Verbindungen, einem Preis $p$ und einem Bedarf $n$. Dabei wird eine Verbindung nur gebildet,
wenn der Spieler mit der jeweiligen Stadt einen Vertrag besitzt und das
Kraftwerk  höchstens drei Felder von der Stadt entfernt ist. So könnte 
...
\caption{Beispiel für ein Optimierungsproblem}
...
und wird deswegen über die Verbindung $x_{21} = 1$ beliefert. $x_{22} = 0$
bedeutet, dass $k_2$ zwar an Stadt $s_2$ liefern könnte, es aber nicht macht. Die
