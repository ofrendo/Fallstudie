...
zwei Achsen X und Y, diese laufen aber nicht im rechten Winkel zu einander:
...
Um die eigentliche Karte zu erzeigen werden als nächstes die Positionen der
...
dann entsprechend reduzier wird.