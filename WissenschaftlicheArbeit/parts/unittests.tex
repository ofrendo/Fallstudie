...
Unter diese Kategorie fallen alle Tests, die Funktionalitäten des Spieles ohne
...
als neue Thread gestartet und parallel ausgeführt. Da dies bei gleichzeitigen
Client Server Tests zu Schwierigkeiten wegen des \texttt{ServerSocket}  führen
würde, wurde die Klasse \texttt{ClientServerMonitor} konzipiert. Diese
implementiert aus zwei Gründen das Singleton Pattern: Erstens muss ein Monitor 
für die \texttt{Object.wait()} Methode objektorientiert und nicht statisch sein
