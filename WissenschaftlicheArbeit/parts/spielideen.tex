% Matthias
\section{Spielideen}\label{matthias:spielideen}
...
dem Spieler das Gefühl zu geben, ein Spiel zu spielen.\\
Während der erste Punkt eine gewisse Recherche möglicher Märkte beinhaltet, geht
...
Bei der Analyse unterschiedlicher Märkte haben sich einige Eigenschaften
herausgestellt, die für die Realisierung eines möglichen Spiels entscheidend
waren:

\begin{itemize}
  \item \textbf{Oligopol}: Da jeder Spieler die Möglichkeit haben soll,
  den Markt zu beeinflussen, sollte es kein Massenmarkt mit hunderten Anbietern
  sein. Tatsächlich ist es für einen Spieler ein weitaus intensiveres
  ...
  hätte, ein Unternehmen des Dienstleistungssektors abzubilden, fiel bei diesem
  Spiel die Entscheidung, das Unternehmen im primären Sektor anzusiedeln. Das
  ...
  die nicht nur darin bestehen, die Kosten für einzelne Abteilungen und den
  Preis für das Endprodukt einzustellen, sondern ihm auch eine gewisse
  Diversifikation und damit die Möglichkeit einer Ausarbeitung von verschiedenen
  Strategien zur Hand zu geben. Dies ließe sich einerseits durch einen Markt mit
  ...
  Möglichkeit, nur manche Abschnitte der Wertschöpfungskette selbst abzubilden.)
\end{itemize}

Als interessantester und vielversprechendster Markt hat sich schließlich der
Energiemarkt --- in diesem Fall der Strommarkt --- herauskristallisiert. Das
Oligopol ist hier insofern gegeben, als dass die vier größten Stromproduzenten
in Deutschland (E.ON, RWE, EnBW und Vattenfall) einen Marktanteil von 80\%
abdecken.

Um nun auch ein Mindestmaß an Handlungsfreiheit zu gewährleisten, wurde beim
Spielkonzept nicht nur der Wertschöpfungsaspekt der direkten Stromproduktion
durch Kraftwerke betrachtet, sondern auch die Gewinnung der dafür erforderlichen
...
kaufen. Darüber hinaus stehen dem Spieler durch die Wahl zwischen diversen
...
dazu gezwungen ist, jede Runde viele Investitionen zu tätigen, um sein Kapital
sinnvoll binden zu können. Im Gegenteil: Der Spieler wird dazu forciert,
einige wenige (im Idealfall wohl überlegte) Entscheidungen zu treffen, die entscheidend
für den weiteren Spielverlauf sein können.
\subsection{Das Spielprinzip}
Neben dem zu realisierenden Markt lag ein großer Fokus auf der Modellierung
dieses Marktes in einem geeigneten Modell, das auf der einen Seite sowohl den
Markt in seinen Grundzügen abbildet, auf der anderen Seite aber auch einen hohen
Wert auf Spielspaß und Spielbarkeit legt.\\
...
Für diese Ziele musste nun eine geeignete Abbildung in ein Spielkonzept gefunden
...
ermöglicht eine Visualisierung des Grundgeschehens und zusätzliche
...
einen gewissen Überblick zu lassen, wurde auf ein rundenbasiertes Spielmodell
gesetzt.
